...
function App() {
  return (
    <div>
        {/* Em JSX, estilos CSS são passados como objetos para o elemento. O nome dos atributos em CSS, escritas em kebab-case, tornam-se os nomes das prorpriedade do objeto, mas escritas em camelCase. O valor das propriedades vai entre aspas, caso não seja números. */}
        <div style={ {marginTop: "20px", backgroundColor: "blue"} }>Teste</div>

        <Box size="small" id="box1">Small LightBlue Box</Box>
        <Box color="pink" id="box2">Small LightBlue Box</Box>
